            ...
            <Card key={item} className="mb-6 p-4">
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="w-full sm:w-1/3 md:w-1/4">
                  <img
                    src="https://assets.customall.io/3c652c223e657d6532372b2826236a24323433282a683e001601020600163768303f76741d0921042a06122f302e1e230b322d377425692d3720656b65302e23332f657d7f77776b6532292e33657d65373f656b6530222537657d21262b34226b6533352e2a657d65653a.png"
                    alt="Product Image"
                    width={200}
                    height={200}
